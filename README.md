...
| [Intensity analysis diagrams](intensity-analysis-diagrams.ipynb) | Generates different diagrams and plots related to intensity analysis.|  
...
| [Region classification](regions-classification.ipynb) | Infer the region label from the a time series of driving factors using random forest classification. This is a complementary way to determine the appropriate number of contiguous regions previously obtained from the Skater clustering algorithm.|  
